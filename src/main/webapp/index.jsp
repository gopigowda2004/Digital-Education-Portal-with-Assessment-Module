...
<style>
   ...
   .navbar h1 {
    ...
    margin: 0;
    color: #04aa6d; /* Primary theme color */
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; /* Clean modern font */
    font-weight: bold; /* Bold for better emphasis */
    text-transform: uppercase; /* Makes the text all uppercase for style */
    letter-spacing: 1.5px; /* Adds spacing between letters for a refined look */
    text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.1); /* Subtle shadow for depth */
    transition: color 0.3s ease-in-out, transform 0.2s ease-in-out; /* Smooth hover effect */
}

.navbar h1:hover {
    color: #028c5a; /* Darker green on hover */
